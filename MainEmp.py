...
from PyQt5.QtGui import QImage, QPalette, QBrush, QPixmap, QIcon, QDesktopServices
...
class empmain(QWidget):
    def __init__(self):
        ...
        self.imageComputer1.setStyleSheet("background:transparent")
    ...
    def help(self):
        print("HI")
        if self.j==0:
            self.imageComputer2.setPixmap(QPixmap("Data/main.png").scaled(3840 / 2, 2080 / 2))

            self.imageComputer2.resize(2000,1030)
            self.imageComputer2.move(0,-2)
            self.j=1
        else:
